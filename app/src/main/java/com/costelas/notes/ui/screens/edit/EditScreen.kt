package com.costelas.notes.ui.screens.edit
...
import com.costelas.notes.ui.components.ColorPicker
import com.costelas.notes.ui.components.HeadingText
import com.costelas.notes.ui.components.TransparentTextField
import java.util.*
...
fun EditScreen(
    ...
    Scaffold(
        ...
        Column(
            modifier = Modifier
                .padding(innerPadding) // ✅ Use the padding here
        ) {
            ...
            Row(
                ...
                IconButton(onClick = { }) {
                    Icon(imageVector = Icons.Rounded.Attachment, contentDescription = "attach button")
                }
                IconButton(onClick = {
